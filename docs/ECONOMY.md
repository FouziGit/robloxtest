...
| Source | Ryo | Fréquence / h | Total / h |
|---|---|---|---|
...
| **Total** | | | **≈ 980 Ryo / h** (≈ 700 pour un joueur moyen) |

VIP : Ryo ×1,5 (≈ 1 400 / h). Premium (abonnés Roblox Premium) : +150 Ryo / jour via le bonus dédié.

## 3. Puits de Ryo (boutique cosmétique)
...
|---|---|---|---|
| Ryo ×1 000 | 99 | 1 000 Ryo | `RyoSmall` |
| Ryo ×3 500 | 299 | 3 500 Ryo (+17 %) | `RyoMedium` |
| Ryo ×8 000 | 599 | 8 000 Ryo (+33 %) | `RyoLarge` |
...
Conversion implicite : 1 R$ ≈ 10-13 Ryo. Un légendaire (8 000 Ryo) vaut ≈ 600 R$ ou ≈ 11 h de jeu : le joueur gratuit peut tout obtenir, le joueur payant gagne du temps.
...
Les abonnés Roblox Premium génèrent des payouts proportionnels au temps passé. Leviers : bonus quotidien Premium (150 Ryo + 30 min de boost d'XP), file prioritaire visuelle (badge), quêtes hebdomadaires bonus. Aucune exclusivité de gameplay.
...
- Exemples : VIP 399 R$ → 279 R$ nets → **1,06 $** ; pass premium 349 R$ → 244 R$ → **0,93 $** ; pack Ryo 599 R$ → 419 R$ → **1,59 $**.
