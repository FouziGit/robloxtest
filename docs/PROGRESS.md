...
- Reste : les autres sorts par ordre d'usage (plusieurs ont un lâcher dessiné après des dégâts qui tombent à 0 : à vérifier un par un) ; les traînées encore texturées au pinceau.
