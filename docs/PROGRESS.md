...
- Reste : Dorure, Spirale, Bond ; Frappe, Caret, Filigrane ; Colophon (plusieurs ont un lâcher dessiné après des dégâts qui tombent à 0 : Frappe 0,21 s, Caret 0,18, Dorure 0,38, Colophon 0,38, Spirale 0,10, Bond 0,12) ; les traînées encore texturées au pinceau ; un essai sur téléphone pour D-124.
