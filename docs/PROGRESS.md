...
- Reste : Frappe, Caret, Filigrane ; Colophon (lâcher dessiné après des dégâts qui tombent à 0 : Frappe 0,21 s, Caret 0,18, Colophon 0,38) ; les traînées encore texturées au pinceau ; un essai sur téléphone pour D-124.
